        ...
        <form class="layui-form" autocomplete="off">
            <div class="layadmin-user-login-box layadmin-user-login-body layui-form">
                <div class="layui-form-item">
                    <label class="layadmin-user-login-icon layui-icon" for="account">&#xe612;</label>
                    <input type="text" name="account" id="account" lay-verify="required" lay-verType="tips" class="layui-input" autocomplete="off">
                </div>
                <div class="layui-form-item">
                    ...
                    <div class="layui-row">
                        ...
                        <div class="layui-col-xs5">
                            <div style="margin-left: 10px;">
                                <img src="/captcha" id="captcha" style="width: 100%;" onclick="javascript:this.src = '/captcha' + '?' + Math.random()">
                            </div>
                        </div>
                    </div>
                </div>
